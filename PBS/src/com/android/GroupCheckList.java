...
public class GroupCheckList extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		{			
			...
			{
				Toast.makeText(GroupCheckList.this, "문자 보내기", Toast.LENGTH_SHORT).show();
		...
		{			
			public void onClick(View arg0)
			{
				Toast.makeText(GroupCheckList.this, "취소", Toast.LENGTH_SHORT).show();
				finish();
			}
		});
	}
