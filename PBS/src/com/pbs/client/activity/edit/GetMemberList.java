...
public class GetMemberList extends ListActivity {
	...
	private void showMemberAdd() {
		...
		LinearLayout addgrouplayout = (LinearLayout) vi.inflate(
				R.layout.dialog_add_member, null);

		final EditText etName = (EditText) addgrouplayout
				.findViewById(R.id.etName);
		final EditText etPhone = (EditText) addgrouplayout
				.findViewById(R.id.etPhone);

		// "전화번호 추가" 다이얼로그 생성
		Builder builder = new AlertDialog.Builder(this).setTitle("전화번호 추가")
	...
	class NewArrayAdapter extends ArrayAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			View row = inflater
					.inflate(R.layout.edit_get_member_list_row, null);
